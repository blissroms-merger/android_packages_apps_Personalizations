...
import com.rising.settings.preferences.colorpicker.SecureSettingColorPickerPreference;
import com.rising.settings.preferences.SecureSettingSeekBarPreference;
import com.rising.settings.preferences.SecureSettingListPreference;
import com.rising.settings.preferences.SecureSettingSwitchPreference;
...
public class MonetSettings extends DashboardFragment implements
    ...
    private SecureSettingColorPickerPreference mAccentColorPref;
    private SecureSettingSwitchPreference mAccentBackgroundPref;
    private SecureSettingColorPickerPreference mBgColorPref;
    private SecureSettingSeekBarPreference mLuminancePref;
    private SecureSettingSeekBarPreference mChromaPref;
            ...
            try {
                ...
                if (enabled && color != null && !color.isEmpty()) {
                    mAccentColorPref.setNewPreviewColor(
                            SecureSettingColorPickerPreference.convertToColorInt(color));
                }
    ...
    private void setColorValue(int color) {
        try {
            JSONObject object = getSettingsJson();
            final String rgbColor = SecureSettingColorPickerPreference.convertToRGB(color).replace("#", "");
