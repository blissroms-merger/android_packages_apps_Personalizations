...
public class SetBannerImageStyles extends SettingsPreferenceFragment {

    private static final int BANNER_COUNT =98;

    private RecyclerView mRecyclerView;
    private List<String> mSetBannerImages;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getActivity().setTitle(R.string.settings_header_image_title);
        mSetBannerImages = loadHeadersList();
    }
    ...
    public class Adapter extends RecyclerView.Adapter<Adapter.CustomViewHolder> {
        ...
        public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.banner_image_option, parent, false);
        ...
        public void onBindViewHolder(CustomViewHolder holder, final int position) {
            ...
            String loadedImage = mSetBannerImages.get(position);
            Bitmap background = getBitmap(holder.mSetBanImage.getContext(), loadedImage);
            ...
            holder.mSetBanImage.setImageBitmap(ImageHelper.getRoundedCornerBitmap(background, radius));
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Settings.System.putIntForUser(resolver,
                            "settings_header_image", position + 1,
        ...
        public class CustomViewHolder extends RecyclerView.ViewHolder {
            ImageView mSetBanImage;

            public CustomViewHolder(View itemView) {
                super(itemView);
                mSetBanImage = (ImageView) itemView.findViewById(R.id.banner_image);
            }
        }

        private void updateActivatedStatus(String image, boolean isActivated) {
            int index = mSetBannerImages.indexOf(image);
            if (index < 0) {
                return;
            }
    ...
    private List<String> loadHeadersList() {
        List<String> bannersList = new ArrayList<String>(BANNER_COUNT);
        for (int i = 1; i <= BANNER_COUNT; i++) {
            bannersList.add("banner_" + i);
        }
        return bannersList;
    }
}
