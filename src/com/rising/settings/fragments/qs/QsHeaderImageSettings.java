 ...
 */
package com.rising.settings.fragments.qs;
...
import com.rising.settings.preferences.AdaptivePreference;
...
public class QsHeaderImageSettings extends SettingsPreferenceFragment
    ...
    private SystemSettingListPreference mTintOptions;
    private SystemSettingColorPickerPreference mColorPicker;
    private SystemSettingSwitchPreference mMasterSwitch;
    private AdaptivePreference mQsHeaderImagePicker;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mMasterSwitch) {
            ...
            String colorHex = SystemSettingColorPickerPreference.convertToARGB(color);
            if (colorHex.equals("#ffffffff")) {
